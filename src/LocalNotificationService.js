...
class LocalNotificationService { 
    ...
    configure = (onOpenNotification, newMessage, newChat) => {
        ...
        PushNotification.configure({
            ...
            onNotification: function (notification) {
                ...
                // notificationData.addNotification(JSON.parse(notification.tag))
                notification.userInteraction = true;
                if (notification.color === 'home')
                onOpenNotification(JSON.parse(notification.tag));

                if (notification.color === 'newMessage')
                newMessage(JSON.parse(notification.tag));

                if (notification.color === 'newChat')
                newChat(JSON.parse(notification.tag));
            },
